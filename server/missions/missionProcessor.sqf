...
diag_log format [AMENO WASTELAND - %1 Misión %2 comenzada: %3", MISSION_PROC_TYPE_NAME, _controllerSuffix, _missionType];
...
diag_log format ["AMENO WASTELAND - %1 Mision%2 esperando a ser completada: %3", MISSION_PROC_TYPE_NAME, _controllerSuffix, _missionType];
...
if (_failed) then
{
	...
	diag_log format ["AMENO WASTELAND - %1 Mision%2 fallida: %3", MISSION_PROC_TYPE_NAME, _controllerSuffix, _missionType];
}
else
{
	// Mission completed
	...
	diag_log format ["AMENO WASTELAND - %1 Mision%2 completada: %3", MISSION_PROC_TYPE_NAME, _controllerSuffix, _missionType];
};
