...
_setupObjects =
{
	...
	_missionHintText = format ["%1 <t color='%3'>%2</t> ha sido inmovilizado, ve a cogerlo para tu equipo!", _vehDeterminer, _vehicleName, mainMissionColor];
};
...
_successExec =
{
	...
	_successHintMessage = format ["El %1 ha sido capturado, bien hecho.", _vehicleName];
};
