...
// ******************************************************************************************
#define ERR_IN_VEHICLE "No puedes hacer esto mientras estás en un vehículo"
#define ERR_TOO_FAR "Te encuentras demasiado lejos"
#define ERR_WRONG_SIDE "La caja no es propiedad de tu equipo"
#define ERR_NOT_WARCHEST "Este objeto no es una caja"
