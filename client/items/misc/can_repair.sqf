...
#define ERR_FULL_HEALTH "El vehículo está reparado"
#define ERR_DESTROYED "El vehículo está demasiado dañado como para repararlo"
#define ERR_NO_REPAIR_KITS "No tienes kits de reparación"
