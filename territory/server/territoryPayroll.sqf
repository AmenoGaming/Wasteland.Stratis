...
while {true} do
{
...

	{
		...
		_message =  format ["Tu equipo ha recibido un bonus de $%1 por mantener %2 territor%3 durante los pasados %4 minutos", [_money] call fn_numbersText, _count, if (_count == 1) then { "y" } else { "ies" }, ceil (_timeInterval / 60)];
